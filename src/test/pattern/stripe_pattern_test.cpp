...
TEST(STRIPE_PATTERN_TEST, TEST_CONSTANT_IN_Y) {
    ...
    ASSERT_EQ(pattern.color_at(Tuple::point(0, 1, 0)), white_);
    ASSERT_EQ(pattern.color_at(Tuple::point(0, 2, 0)), white_);
}
...
TEST(STRIPE_PATTERN_TEST, TEST_CONSTANT_IN_Z) {
    ...
    ASSERT_EQ(pattern.color_at(Tuple::point(0, 0, 0)), white_);
    ASSERT_EQ(pattern.color_at(Tuple::point(0, 0, 1)), white_);
    ASSERT_EQ(pattern.color_at(Tuple::point(0, 0, 2)), white_);
}
...
TEST(STRIPE_PATTERN_TEST, TEST_ALTERNATES_IN_X) {
    ...
    ASSERT_EQ(pattern.color_at(Tuple::point(0, 0, 0)), white_);
    ASSERT_EQ(pattern.color_at(Tuple::point(0.9, 0, 0)), white_);
    ASSERT_EQ(pattern.color_at(Tuple::point(1, 0, 0)), black_);
    ASSERT_EQ(pattern.color_at(Tuple::point(-0.1, 0, 0)), black_);
    ASSERT_EQ(pattern.color_at(Tuple::point(-1, 0, 0)), black_);
    ASSERT_EQ(pattern.color_at(Tuple::point(-1.1, 0, 0)), white_);
}
